...
public class ContractPriceInfoVO
{
    ...
    private List<ContractPricesVO> contractPrices;
    ...
    public List<ContractPricesVO> getContractPrices()
    {
        return contractPrices;
    }
    
    public void setContractPrices(List<ContractPricesVO> contractPrices)
    {
